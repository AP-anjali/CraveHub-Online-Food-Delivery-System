...
export const sendOtp = async (req, res) => {
    ...
    {
        return res.status(500).json({message : `otp sending error ${error}`});
    }
}
...
export const verifyOtp = async (req, res) => {
    ...
    {
        return res.status(500).json({message : `otp verifying error ${error}`});
    }
};
...
export const resetPassword = async (req, res) => {
    try
    {
        ...
        {
            return res.status(400).json({message : "User does not exist or OTP verification is required..!"});
        }
    ...
    {
        return res.status(500).json({message : `password reseting error ${error}`});
    }
};
