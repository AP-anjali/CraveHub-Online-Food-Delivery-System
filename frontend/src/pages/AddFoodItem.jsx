...
function AddFoodItem() {
  ...
  const categories = ["snacks", "main course", "desserts", "pizza", "burgers", "sandwitches", "south indian", "north indian", "chinese", "fast food", "others"];
  ...
  const handleImage = (e) => {
    ...
    setFrontendImage(URL.createObjectURL(file));  // creating an url of an image to acess in frontend using URL object provided by js
  };
      ...
      <div className='max-w-lg w-full bg-white shadow-xl rounded-2xl p-8 border border-orange-100 '>
        ...
        <form className='space-y-5' onSubmit={handleSubmit}>
          ...
          <div>
            ...
            <input type="number" placeholder='Enter Price' className='w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500' onChange={(e) => setPrice(e.target.value)} value={price} />
          </div>
